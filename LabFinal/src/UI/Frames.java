...
public class Frames extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String textoDos = jTextField2.getText();
      
  
      
      try{
         int  numUno = parseInt(texto);
         int numDos = parseInt(textoDos);
          int suma =  Sumar(numUno, numDos );
           jLabel1.setText(String.valueOf(suma));
      }
      catch(Exception e)
